...
<body>
    <div class="bg-gray-100">
        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900 ">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="/img/logo.jpeg" class="h-8 " alt="RausyanFikr Institute Logo" />
                    <span class="self-center text-base font-semibold whitespace-nowrap dark:text-white">RausyanFikr
                        Institute</span>
                </a>
                <div class="flex md:order-2">
                    ...
                    <div class="relative hidden md:block">
                        ...
                        <input type="text" id="search-navbar"
                            class="block w-full p-2 ps-10 text-sm text-gray-900  ryo1nded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                            placeholder="Search...">
                    </div>
                    ...
                    <ul
                        ...
                        <li>
                            <a href="#"
                                ...
                                aria-current="page">Katalog</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-red-700 md:p-0 md:dark:hover:text-red-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Kontak</a>
                        </li>
                        {{-- <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-red-700 md:p-0 dark:text-white md:dark:hover:text-red-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
                        </li> --}}
                    </ul>
                </div>
            </div>
        ...
        <div class="max-w-screen-xl mx-auto p-4">
            <div>
                <p class="text-center font-black uppercase">Katalog</p>
            </div>
        </div>
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div>
                    <a href="#"
                        ...
                        <img class="object-cover w-full rounded-t-lg h-52 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg"
                            src="/img/book1.jpeg" alt="">
                        <div class="p-4 leading-normal text-sm">
                            <table class="text-left  ">
                                <thead>
                                    <tr>
                                        <th scope="col" class="py-1  text-base" colspan="3"> Epistemologi Ibadah

                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="font-medium py-1">Penulis</td>
                                        <td class=" py-1">&nbsp;:&nbsp;</td>
                                        <td class=" py-1">Muhammad Baqir Shadr</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" py-1">&nbsp;:&nbsp;</td>
                                        <td class=" py-1">Cetakan 1 2013 <br> Cetakan 2 2015</td>
                                    </tr>
                                    <tr>
                                        <td class="font-medium py-1">No. ISBN</td>
                                        <td class=" py-1">&nbsp;:&nbsp;</td>
                                        <td class=" py-1">978-602-1602-05-8</td>
                    ...
                    <a href="#"
                        ...
                        <div class="p-4 leading-normal text-sm">
                            <table class="text-left  ">
                                <thead>
                                    <tr>
                                        <th scope="col" class="py-1  text-base" colspan="3"> Epistemologi
                                            Ibadah
            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <a href="#" class="flex items-center">
                            <img src="/img/logo.jpeg" class="h-8 me-3"
                                alt="RausyanFikr Institute Logo" />
                            <span
                                class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">RausyanFikr Institute</span>
                        </a>
                    </div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a
                            href="https://flowbite.com/" class="hover:underline">RausyanFikr Institute™</a>. All Rights Reserved.
                    </span>
