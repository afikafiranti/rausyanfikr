                ...
                <div id="editProductForm" class="flex justify-center">
                    <form action="{{ route('admin.update', $buku->id) }}" method="POST" class="w-full max-w-md">
                        ...
                        <div class="mb-4"> <!-- Menambahkan margin bottom pada setiap elemen input -->
                            <label for="judul"
                                class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Judul Buku</label>
                        ...
                        <div class="mb-4">
                            <label for="isbn"
                                class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">No ISBN</label>
