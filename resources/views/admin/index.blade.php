            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="#" class="flex ml-2 md:mr-24">
                        <img src="/img/logo.jpeg" class="h-8 mr-3" alt="RausyanFikr Institute Logo" />
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">RausyanFikr
                            Institute</span>
                    </a>
                </div>
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                        sidebar-toggle-item>Katalog</span>
                                        ...
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td
                                                ...
                                                <div class="text-base font-semibold text-gray-900 dark:text-white">
                                                    Judul</div>
                                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400"> Sub
                                                </div>
                                            </td>
                                            <td
                    ...
                    <form action="#">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="terbit" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tahun Terbit"></textarea>
                            </div>
                            <div>
                                <label for="isbn"
